...
module.exports = {
    ...
    plugins: [
        new CopyWebpackPlugin([
            {
                from: __dirname + '/node_modules/@super-fe/swan-core/dist/box/**',
                to: __dirname + '/dist/box/[1].[ext]',
                test: /box\/(.*)\.[^.]+$/
            },
            {
                from: __dirname + '/node_modules/@baidu/swan-components/dist/styles_index.css',
            ...
            {
                from: __dirname + '/node_modules/@baidu/swan-dev-hook/dist/**',
                to: __dirname + '/dist/box/swan-devhook/[name].[ext]'
            }
        ]),
